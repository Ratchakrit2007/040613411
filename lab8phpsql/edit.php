...
$stmt->bindParam(7, $_POST["username"]); //ถ้าไม่มีตัวนี้จะไม่สามารถแก้ไขข้อมูลที่ส่งมาได้
//$stmt->execute(); // เริ่มเพิ่มข้อมูล
//$username = $_POST["username"];

//header("location: workshop5.1.php?username=".$username); // กลับไปแสดงผลหน้าข้อมูล
